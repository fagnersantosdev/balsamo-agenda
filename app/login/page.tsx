    ...
    <main className="min-h-screen flex items-center justify-center bg-white p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-[#083536]/50 text-sm mt-2 font-medium uppercase tracking-[0.2em]">
            Bálsamo Gestão v2.0
          </p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-4">
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-[#97709B]/40 w-5 h-5" />
                <input
                  type="email"
              ...
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-[#97709B]/40 w-5 h-5" />
                <input
                  type="password"
        ...
        {/* Footer sutil */}
        <p className="text-center mt-10 text-[10px] text-[#083536]/30 font-black uppercase tracking-[0.3em]">
