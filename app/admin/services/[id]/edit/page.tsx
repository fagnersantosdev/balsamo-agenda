...
export default function EditServicePage() {
  ...
  const labelClass = "block text-xs font-bold uppercase tracking-widest text-[#083536]/80 mb-2 ml-1";
  const inputClass = "w-full pl-10 pr-4 py-3 bg-white border border-[#8D6A93]/30 rounded-2xl focus:ring-2 focus:ring-[#8D6A93] focus:border-transparent outline-none transition-all text-[#083536]";

  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center opacity-50">
        <Loader2 className="w-10 h-10 animate-spin text-[#97709B] mb-4" />
        <p className="font-medium text-[#97709B]">Carregando serviço...</p>
      </div>
    );
  }
    ...
    <main className="max-w-2xl mx-auto p-1 sm:p-8 pb-32">
      ...
      <div className="bg-white/90 backdrop-blur-md rounded-[2.5rem] p-8 shadow-2xl shadow-[#8D6A93]/5 border border-[#8D6A93]/10 relative">
        <header className="text-center mb-10">
          <div className="w-14 h-14 bg-[#FAF8ED] text-[#97709B] rounded-2xl flex items-center justify-center mx-auto mb-4">
            <Edit3 size={28} />
          </div>
          <h1 className="text-3xl font-bold text-[#083536]">Editar Serviço</h1>
          <p className="text-[#083536]/60 text-sm mt-2">Atualize as informações do tratamento selecionado.</p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <Sparkles className="absolute left-3 top-1/2 -translate-y-1/2 text-[#97709B]/80 w-5 h-5" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 text-[#97709B]/80 w-5 h-5" />
            ...
            <div>
              ...
              <div className="relative">
                <Clock className="absolute left-3 top-1/2 -translate-y-1/2 text-[#97709B]/80 w-5 h-5" />
          ...
          <div>
            ...
            <div className="relative">
              <ListPlus className="absolute left-3 top-4 text-[#97709B]/80 w-5 h-5" />
              <textarea
                name="details"
          ...
          <button
            disabled={saving}
            className="w-full bg-[#083536] text-[#FAF8ED] py-4 rounded-2xl font-bold text-lg shadow-xl shadow-[#083536]/20 hover:bg-[#2a4d31] active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50"
          >
